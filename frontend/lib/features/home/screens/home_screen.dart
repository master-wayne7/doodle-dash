...
import 'package:doodle_dash/features/home/widgets/avatar_selector.dart';
import 'package:doodle_dash/features/shared/widgets/avatar_display.dart';
import 'package:doodle_dash/features/home/widgets/about_card.dart';
import 'package:doodle_dash/features/home/widgets/how_to_play_card.dart';
  ...
  void _joinRoom() {
    ...
    context.push(
      ...
      extra: {
        'nickname': nickname,
        'roomId': roomId,
        'avatar': {'color': _colorIndex, 'eyes': _eyesIndex, 'mouth': _mouthIndex},
      },
    );
  }
      ...
      body: Container(
        ...
        child: Center(
          child: SingleChildScrollView(
            child: Padding(
              padding: const EdgeInsets.symmetric(vertical: 32.0).copyWith(bottom: 0),
              child: Column(
                ...
                children: [
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor: const Color(0xFF5DF22F), // skribbl green
                  ...
                  Container(
                    width: double.infinity,
                    color: const Color(0xBF0C2C96), // Subtle dark overlay for the bottom section
